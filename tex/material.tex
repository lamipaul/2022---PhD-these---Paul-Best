...
In this chapter, I will introduce the material used for the experiments conducted throughout this thesis. It takes form as underwater acoustic data, containing different signals, and recorded at different places and times. This chapter will thus revolve around two axis : the studied signals, and the recording setups. 

The diverse set of target signals I will describe are those for which I have built detection systems. Their characteristics are summarised in Table \ref{tab:recap_data}, and each subsection then underpins the current scientific knowledge about them, especially regarding their context of emission.
...
\begin{table}[ht]
    ...
    \begin{tabularx}{1\linewidth}{|X|X|X|X|X|X|X|}
        \hline
        \textbf{Species} & \textbf{Sperm whale clicks} & \textbf{Fin whale 20Hz pulses} & \textbf{Orca calls} & \textbf{Dolphin whistles} & \textbf{Humpback whale calls} \\ \hline
        ...
        \textbf{Centroid frequency (Hz)} & 12,000 & 20 & [500; 5,000] & [5,000. 20,000] & [300; 3,000] \\ \hline
...
%        \textbf{Interval between signals (sec)} & [0.1, 1] & [10, 25] &  &  &  \\ \hline
    \end{tabularx}
    \caption{Summary of the target signals for the detection systems built through this thesis.}
