...
\begin{figure}
    ...
    \caption{A dolphin using echolocation to hunt (image credit : Uko Gorter - American Cetacean Society)}
    \label{fig:my_label}
\end{figure}
...
Besides PAM, visual surveys is the second main approach to the biological study of cetaceans. Each comes with its pros and cons. The acoustic approach enables low-cost, long term surveys : placing a fixed antenna allows to monitor biological activities for months in a row, requiring human intervention only for the installation and extraction of the recording system. In contrast, the visual approach demands a continuous human implication throughout the survey, in the relatively inaccessible marine environment.
...
\begin{figure}
    \centering
    \includegraphics[width=.8\linewidth]{fig/speed_canada.jpg}
